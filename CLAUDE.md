...
| ユニットテスト | 判定式全体・統合・E2E・AIモジュール・フロントエンド・i18n・DO helpers・rating・ranking・shop購入・hex_utils・special・presetTeams・match_friend・platform auth(tokenStore/ssoFragment) | ✅ 711 tests passing (+10 skip: ライブE2E) |
...
```bash
npm test              # vitest run（全711テスト + 10 E2Eスキップ）
npm run test:watch
